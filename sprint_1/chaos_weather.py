...
def get_number_chaos_days(n: int, lst: list[int]) -> int:
    if len(lst) == 1:
        return 1
    # i = 1
    result = 0
...
@pytest.mark.parametrize(
    "n, lst, expected", [(5, [1, 2, 5, 4, 8], 2), (7, [-1, -10, -8, 0, 2, 0, 5], 3)]
)
def test_get_number_chaos_days(n: int, lst: list[int], expected: int) -> None:
    assert get_number_chaos_days(n, lst) == expected
